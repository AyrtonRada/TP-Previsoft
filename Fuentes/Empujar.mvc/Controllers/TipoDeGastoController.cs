...
namespace Empujar.mvc.Controllers
{
    public class TipoDeGastoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                return RedirectToAction("Error", "Home", new { mensaje = "Error al ingresar al modulo de Tipos de Gastos. Intente mas tarde." });
            }
        }
        ...
        public async Task<JsonResult> SaveInfo([Bind("ID,Nombre")] TipoDeGastoViewModel tipo, int Numeral, string Mode)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Mode == "A")
                {
                    ...
                    try
                    {
                        TipoDeGasto tipoDB = new TipoDeGasto
                        {
                            Nombre = tipo.Nombre
                        };
